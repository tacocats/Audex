...
import fs from '../libs/fsExtra.js'
import rra from '../libs/recursiveReaddirAsync.js'
...
export async function getFileTimestampsWithIno(path) {
  try {
 ...
 * @returns {boolean}
 */
export async function checkPathIsFile(filepath) {
  try {
 ...
 * @returns {FilePathItem}
 */
export const getFilePathItemFromFileUpdate = (fileUpdate) => {
 ...
 */
export async function copyToExisting(srcPath, destPath) {
  return new Promise((resolve, reject) => {
